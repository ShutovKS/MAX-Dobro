// FILE: frontend/src/components/ui/icons/NatureProtectorIcon.tsx
// VERSION: 1.0.0
// START_MODULE_CONTRACT
//   PURPOSE: Nature-protection volunteer category illustration icon.
...
//
// START_MODULE_MAP
//   NatureProtectorIcon - SVG icon for nature-protection volunteer category
// END_MODULE_MAP
//
...
// START_CONTRACT: NatureProtectorIcon
//   PURPOSE: Render the nature-protector SVG icon
//   INPUTS: { props: IconProps - SVG attributes }
//   OUTPUTS: { ReactElement - SVG icon }
//   SIDE_EFFECTS: none
//   LINKS: M-FRONTEND-UI, V-M-FRONTEND-UI
// END_CONTRACT: NatureProtectorIcon
...
<path d="M514.5 516.6m-484.5 0a484.5 484.5 0 1 0 969 0 484.5 484.5 0 1 0-969 0Z" fill="#44C0C6"/>
