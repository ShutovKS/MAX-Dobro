// FILE: frontend/src/components/ui/icons/BronzeMedalIcon.tsx
// VERSION: 1.0.0
// START_MODULE_CONTRACT
//   PURPOSE: Bronze leaderboard medal icon.
...
//
// START_MODULE_MAP
//   BronzeMedalIcon - bronze medal SVG for third place
// END_MODULE_MAP
//
...
// START_CONTRACT: BronzeMedalIcon
//   PURPOSE: Render the bronze medal SVG icon
//   INPUTS: { props: IconProps - SVG attributes }
//   OUTPUTS: { ReactElement - SVG icon }
//   SIDE_EFFECTS: none
//   LINKS: M-FRONTEND-UI, V-M-FRONTEND-UI
// END_CONTRACT: BronzeMedalIcon
