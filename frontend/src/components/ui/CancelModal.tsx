  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 animate-fade-in" role="dialog"
      ...
      <div
        ...
        <h2 className="text-2xl font-bold text-text-primary">Отменить участие?</h2>
        ...
        <div
          ...
          <button
            onClick={onConfirm}
            className="flex-1 bg-transparent text-action-danger font-semibold py-3 px-4 rounded-xl hover:bg-red-50 transition-colors"
          >
            Да, отменить
          </button>
          <button
