  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 animate-fade-in" role="dialog"
      ...
      <div
        ...
        <h2 id="purchase-title" className="text-2xl font-bold text-text-primary">Подтвердите покупку</h2>

        <div className="w-full text-left text-base space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-gray-500">Товар:</span>
            <span className="font-semibold text-text-primary">{rewardName}</span>
          </div>
          <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center border-t border-gray-200 pt-3 mt-3">
            ...
            <div className="flex items-center space-x-1 font-bold text-text-primary">
              <Sparkles className="w-4 h-4 text-gray-500"/>
        ...
        <div className="w-full flex space-x-3 pt-2">
          <button
            onClick={onCancel}
            className="flex-1 bg-transparent text-brand font-semibold py-3 px-4 rounded-[12px] hover:bg-gray-100 transition-colors"
          >
            Отмена
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 bg-brand text-white font-bold py-3 px-4 rounded-[12px] shadow-lg hover:bg-brand-dark transition-opacity"
          >
            Купить
          </button>
        </div>
